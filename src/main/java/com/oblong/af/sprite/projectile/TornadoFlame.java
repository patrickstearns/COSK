...
public class TornadoFlame extends Prop {

    private Prop parent;
    private double initialAngle = Math.random()*Math.PI*2;
    private int timeToLive = 64;

	public TornadoFlame(AreaScene scene, Prop parent){
		super("TornadoFlame", scene, 0, 4);
        setSheet(Art.flame);
        setYPic(4);
        setXPicO(0);
        setYPicO(0);
